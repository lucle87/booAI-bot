            ...
            <div className="wallet-modal" onClick={(event) => event.stopPropagation()}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                <div>
                  ...
                  <p style={{ margin: '0.4rem 0 0', color: '#adb3d7' }}>Choose a wallet to connect.</p>
                </div>
              ...
              {walletOptions.map((option) => (
                <button
                  ...
                  style={{
                    ...
                    padding: '1rem',
                    marginBottom: '0.8rem',
                    background: option.disabled ? 'rgba(255,255,255,0.04)' : '#141428',
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div>
                      ...
                      <div style={{ color: '#adb3d7', fontSize: '0.95rem', marginTop: '0.25rem' }}>{option.description}</div>
                    </div>
                  </div>
                  {option.disabled && <span style={{ fontSize: '0.85rem', color: '#8b8fbc' }}>Coming Soon</span>}
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="card card-dark">
            ...
            <div style={{ marginBottom: '1rem', border: '1px solid rgba(255,255,255,0.06)', padding: '0.5rem', borderRadius: 8 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                <strong style={{ color: '#d7c9ff' }}>AI Assistant</strong>
              ...
              {chatOpen && (
                <div>
                  <div style={{ maxHeight: 180, overflowY: 'auto', padding: '0.5rem', background: 'rgba(0,0,0,0.04)', borderRadius: 6 }}>
                    {messages.map((m, i) => (
                      <div key={i} style={{ display: 'flex', justifyContent: m.role === 'assistant' ? 'flex-start' : 'flex-end', marginTop: 8 }}>
                        <div style={{ maxWidth: '82%', padding: '0.5rem 0.75rem', borderRadius: 12, background: m.role === 'assistant' ? 'linear-gradient(90deg,#7c4dff,#4f7bff)' : 'rgba(255,255,255,0.06)', color: m.role === 'assistant' ? '#fff' : '#e6e9f6' }}>
                          {m.text}
                        </div>
                      </div>
                    ))}
