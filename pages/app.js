    ...
    <>
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .wallet-connected { display: flex; flex-direction: column; gap: 8px; }
        .wallet-addr { font-family: 'Space Mono', monospace; font-size: 11px; color: #00d4aa; }
        ...
        .wallet-balance { font-size: 11px; color: #52526a; }
        ...
        /* LOADING DOTS */
        .loading-dots { display: flex; gap: 4px; align-items: center; padding: 12px 16px; }
        ...
        .pay-amount-val { font-family: 'Space Grotesk', sans-serif; font-size: 20px; font-weight: 700; color: #00d4aa; }
            ...
            <div className="wallet-box">
              {wallet ? (
                <div className="wallet-connected">
                  ...
                  <div className="wallet-net"><div className="wallet-dot" />ARC Testnet</div>
                  <div className="wallet-balance">Balance: checking...</div>
                </div>
              ) : (
        ...
        <div className="chat-panel">
          <div className="chat-topbar">
            ...
            <div className="chat-topbar-right">
              ...
              {!wallet && (
                <button className="btn-connect" style={{ padding: '6px 16px', fontSize: 12 }} onClick={() => setShowWalletModal(true)}>
                  Connect Wallet
                </button>
              )}
            </div>
          ...
          {/* CHIPS — show only when 1 message */}
          {messages.length === 1 && (
      ...
      {showWalletModal && (
        <div className="modal-overlay" onClick={() => setShowWalletModal(false)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-sub">Choose your wallet to get started on ARC Testnet</div>
        ...
        <div className="modal-overlay">
          <div className="pay-modal">
            ...
            <div className="pay-btns">
              ...
              <button className="btn-pay" onClick={handleExecuteTask}>Pay & Execute →</button>
            </div>
          </div>
        </div>
      )}
